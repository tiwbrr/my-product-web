...
export default async function AdminPage() {
  ...
  return <main className="admin-shell">
    ...
    <div className="admin-main">
      <header className="admin-top"><div><span className="eyebrow">SELL ID MANAGEMENT</span><h1>สวัสดี, {admin.name}</h1><p>จัดการไอดีเกม หมวดเกม และช่องทางติดต่อได้จากที่นี่</p></div><Link href="/" className="button button-outline">ดูหน้าร้าน ↗</Link></header>
