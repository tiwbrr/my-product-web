...
export default async function AdminPage() {
  ...
  return <main className="admin-shell">
    ...
    <div className="admin-main">
      ...
      <section className="admin-panel" id="contacts"><div className="panel-heading"><div><span className="panel-icon">◎</span><span><h2>ช่องทางติดต่อและ YouTube Playlist</h2><p>จัดการ LINE QR Code, Facebook และเพลย์ลิสต์ที่แสดงบนหน้าร้าน</p></span></div></div><ContactSettingsForm settings={settings} /></section>
