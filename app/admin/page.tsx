  ...
  return <main className="admin-shell">
    <aside className="admin-sidebar">
      ...
      <nav>
        ...
        <a href="#contacts"><span>◎</span> ติดต่อและ Playlist</a>
    ...
    <div className="admin-main">
      <header className="admin-top"><div><span className="eyebrow">SELL ID MANAGEMENT</span><h1>สวัสดี, {admin.name}</h1><p>จัดการไอดีเกม หมวดเกม ช่องทางติดต่อ และ YouTube Playlist ได้จากที่นี่</p></div><Link href="/" className="button button-outline">ดูหน้าร้าน ↗</Link></header>
      ...
      <section className="admin-panel" id="contacts"><div className="panel-heading"><div><span className="panel-icon">◎</span><span><h2>ช่องทางติดต่อและ YouTube Playlist</h2><p>เพิ่มช่องทางได้ไม่จำกัด พร้อมไอคอน ลิงก์ หรือ QR Code และจัดการเพลย์ลิสต์หน้าร้าน</p></span></div></div><ContactSettingsForm settings={settings} /></section>
